...
const std::string EEF_FRAME_ID = "ur5e_tool0";
const std::string BASE_FRAME_ID = "ur5e_base";
                     ...
                     std::unique_ptr<control_msgs::msg::JointJog>& joint)
{
  ...
  // if (dpadPressed || abxyPressed || lrPressed) {
    ...
    joint->joint_names.push_back("ur5e_elbow_joint");
    joint->velocities.push_back(axes[D_PAD_X]);
    joint->joint_names.push_back("ur5e_shoulder_lift_joint");
    joint->velocities.push_back(-axes[D_PAD_Y]);

    joint->joint_names.push_back("ur5e_shoulder_pan_joint");
    joint->velocities.push_back(buttons[LEFT_STICK_CLICK] - buttons[RIGHT_STICK_CLICK]);

    // Map the diamond to the distal joints
    joint->joint_names.push_back("ur5e_wrist_1_joint");
    joint->velocities.push_back(buttons[A] - buttons[B]);
    joint->joint_names.push_back("ur5e_wrist_2_joint");
    joint->velocities.push_back(buttons[X] - buttons[Y]);

    //std::cout << "dpadPressed: "<< dpadPressed << std::endl;
...
public:
    ...
    : Node("my_joy_to_twist_publisher", options), frame_to_publish_(BASE_FRAME_ID)
  {
    ...
    collision_pub_thread_ = std::thread([this]() {
      ...
      collision_object.header.frame_id = "ur5e_base";
  ...
  void joyCB(const sensor_msgs::msg::Joy::ConstSharedPtr& msg)
  {
    ...
    else
    {
      ...
      RCLCPP_INFO(this->get_logger(), "Publishing jog  message!");
    }
  }
...
RCLCPP_COMPONENTS_REGISTER_NODE(servoing::MyJoyToServoPub)
